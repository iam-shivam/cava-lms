                        ...
                        <tr class="<?php echo $q['status'] === 'Resolved' ? 'table-light' : ''; ?>">
                            ...
                            <td style="max-width: 280px;">
                                ...
                                <?php if (strlen($q['query_message']) > 80): ?>
                                    <button type="button" class="btn btn-view-more mt-1" data-bs-toggle="modal" data-bs-target="#queryModal<?php echo $q['id']; ?>">
                                        View More &raquo;
                                    </button>
                                <?php endif; ?>
                                ...
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    <?php if ($q['status'] === 'Pending'): ?>
                                        <a href="queries.php?action=resolve&id=<?php echo $q['id']; ?>"
                                           class="btn btn-sm btn-success rounded-pill px-3 py-1 text-nowrap" style="font-size: 0.78rem;"
                                           onclick="confirmAction(event, 'Are you sure you want to mark this query as resolved? This action cannot be undone.', this.href);">
                                        ...
                                        <div class="modal-content rounded-4 border-0 shadow">
                                            <div class="modal-header border-bottom-0 pb-0">
                                                <div class="d-flex align-items-center gap-2">
                                                     <span class="badge bg-dark rounded-pill px-2 py-1 fw-bold text-white" style="font-size: 0.7rem; letter-spacing: 0.5px;">
                                                         <i class="fa-solid fa-ticket me-1"></i>Ticket #<?php echo htmlspecialchars($q['ticket_number'] ?? '------'); ?>
                                                     </span>
