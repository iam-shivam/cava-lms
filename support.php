            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 lms-reveal lms-reveal-left">
                    <div class="custom-card border-0 shadow-sm p-4 p-md-5 bg-white rounded-4">
                        ...
                        <form action="submit_query.php" method="POST" id="queryFormSupport" onsubmit="return validateWordLimit('queryFormSupport')">
                            <div class="mb-3">
                            ...
                            <button type="submit" id="querySubmitBtnSupport" class="lp-btn-primary w-100 py-3" style="border-radius: 100px;">
...
function updateWordCount(textarea) {
    ...
    var submitBtn = document.getElementById('querySubmitBtnSupport');
    if (submitBtn) {
        if (words >= 100) {
